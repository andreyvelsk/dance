...
1. Create the Telegram-Bot and save the Bot-Token parameter on the settins page Contact Form 7 - CF7 Telegram.
2. Paste the shortcode <code>[telegram]</code> in your contact form template for activate sending to Telegaram.
3. Get your Chat ID and save this on the settins page Contact Form 7 - CF7 Telegram. You can see your Chat ID by typing anything to Telegram-Bot <code>@wpcf7Bot</code>.
4. Start chat with your bot, created on first step. Use the same Telegram-account as for step #3. Just push the START button.
